...
public class GroupController {
     ...
     * @return 成功
     */
    @RequestMapping(value = "/api/short-link/admin/v1/group/save", method = RequestMethod.POST)
     ...
     * @return 所有分组
     */
    @RequestMapping(value = "/api/short-link/admin/v1/group/query", method = RequestMethod.GET)
     ...
     * @return 成功
     */
    @RequestMapping(value = "/api/short-link/admin/v1/group/update", method = RequestMethod.POST)
     ...
     * @return 成功
     */
    @RequestMapping(value = "/api/short-link/admin/v1/group/delete", method = RequestMethod.POST)
     ...
     * @return 成功
     */
    @RequestMapping(value = "/api/short-link/admin/v1/group/sort", method = RequestMethod.POST)
